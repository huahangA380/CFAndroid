...
public class CroMainFragment extends ListFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		MyAdapater adapter = new MyAdapater(getActivity());
		setListAdapter(adapter);

		return v;
	}

	public static CroMainFragment newInstance(int sectionNumber) {
